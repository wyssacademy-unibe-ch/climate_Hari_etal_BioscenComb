...
def calculate_landclim(taxas, models, model_names, bioscen_model_names, scenarios, ssprcps_longs, ssprcps_shorts, time=35):
                        ...
                        for k, ssprcp_long in enumerate(ssprcps_longs):
                            for l, ssprcp_short in enumerate(ssprcps_shorts):
                                ...
                                for i, species_name in enumerate(formatted_names[:10]):
                                    ...
                                    z = bioscen_species[bioscen_model_name + '_' + scenario + '_' + years[13]]
