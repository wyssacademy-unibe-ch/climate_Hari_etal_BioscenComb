...
with open(os.path.join(output_dir, f"mean_newvalue_change_habitat_{scenario}_{time}_gain.pkl"), "wb") as f:
    pickle.dump(mean_newvalue_change, f)

with open(os.path.join(output_dir, f"mean_sum_bin_change_habitat_{scenario}_{time}_gain.pkl"), "wb") as f:
    pickle.dump(mean_sum_bin_change, f)

with open(os.path.join(output_dir, f"mean_land_use_change_habitat{scenario}_{time}_gain.pkl"), "wb") as f:
    pickle.dump(mean_land_use_change, f)

with open(os.path.join(output_dir, f"mean_values_habitat{scenario}_{time}_gain.pkl"), "wb") as f:
    pickle.dump(mean_values, f)

with open(os.path.join(output_dir, f"mean_sum_bin_change_habitat_{scenario}_{time}_gain.pkl"), "wb") as f:
    pickle.dump(mean_sum_bin_change_habitat, f)

with open(os.path.join(output_dir, f"uncertainties_sdm_habitat_{scenario}_{time}_gain.pkl"), "wb") as f:
    pickle.dump(uncertainties_sdm_habitat, f)

with open(os.path.join(output_dir, f"uncertainties_gcm_habitat_{scenario}_{time}_gain.pkl"), "wb") as f:
