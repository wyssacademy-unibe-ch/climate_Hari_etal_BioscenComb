...
df_forest.to_csv(f'/storage/homefs/ch21o450/scripts/BioScenComb/habitat_counts/df_forest{time}_{taxa}_{model}.csv', index=False)

df_non_forest.to_csv(f'/storage/homefs/ch21o450/scripts/BioScenComb/habitat_counts/df_non_forest{time}_{taxa}_{model}.csv', index=False)
