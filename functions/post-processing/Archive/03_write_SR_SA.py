...
for model in models:
    ...
    for future_time in future_times:
        for scenario in scenarios:
            ...
            filename = f"/storage/scratch/users/ch21o450/data/SR/SA_{taxa}_{model}_{historical_time}_{scenario}_summedprobs_newvalue.nc"
            mean_value_bin_hist.to_netcdf(filename)

            filename2 = f"/storage/scratch/users/ch21o450/data/SR/SA_{taxa}_{model}_{historical_time}_{scenario}_summedprobs_sum.nc"
            ...
            filename = f"/storage/scratch/users/ch21o450/data/SR/SA_{taxa}_{model}_{future_time}_{scenario}_summedprobs_newvalue.nc"
            mean_value_bin_future.to_netcdf(filename)

            filename2 = f"/storage/scratch/users/ch21o450/data/SR/SA_{taxa}_{model}_{future_time}_{scenario}_summedprobs_sum.nc"
