...
for taxa in taxas:
    ...
    for future_time in future_times:
        for scenario in scenarios:
            ...
            filename = f"/storage/homefs/ch21o450/scripts/BioScenComb/intermediate_results/test/{taxa}_{model}_{historical_time}_{scenario}_species_count_per_SCDM_00th_mean_value_bin_future.nc"
            mean_value_bin_hist.to_netcdf(filename)

            filename2 = f"/storage/homefs/ch21o450/scripts/BioScenComb/intermediate_results/test/{taxa}_{model}_{historical_time}_{scenario}_species_count_per_SCDM_00th_mean_sum_bin_future.nc"
            ...
            filename = f"/storage/homefs/ch21o450/scripts/BioScenComb/intermediate_results/test/{taxa}_{model}_{future_time}_{scenario}_species_count_per_SCDM_00th_mean_value_bin_future.nc"
            mean_value_bin_future.to_netcdf(filename)

            filename2 = f"/storage/homefs/ch21o450/scripts/BioScenComb/intermediate_results/test/{taxa}_{model}_{future_time}_{scenario}_species_count_per_SCDM_00th_mean_sum_bin_future.nc"
