...
for habitat in habitats:
    for sdm in sdms:
        for taxa in taxas:
            ...
            netcdf_path_format_future = "/storage/scratch/users/ch21o450/data/LandClim_Output/Dispersal2/{}/{}/{}/{}/{}_[{}].nc"
            netcdf_path_format_hist = "/storage/scratch/users/ch21o450/data/LandClim_Output/Dispersal2/{}/{}/EWEMBI/{}_[{}].nc"
...
for habitat in habitats:
    for sdm in sdms:
        for gcm in gcms:
            ...
            # Output file paths
            newvalue_hist_sum_path = os.path.join(output_dir, f"newvalue_hist_sum_{sdm}_{gcm}_{habitat}_{scenario}_{time}_dispersal2.pkl")
            newvalue_future_sum_path = os.path.join(output_dir, f"newvalue_future_sum_{sdm}_{gcm}_{habitat}_{scenario}_{time}_dispersal2.pkl")
            sum_bin_hist_sum_path = os.path.join(output_dir, f"sum_bin_hist_sum_{sdm}_{gcm}_{habitat}_{scenario}_{time}_dispersal2.pkl")
            sum_bin_future_sum_path = os.path.join(output_dir, f"sum_bin_future_sum_{sdm}_{gcm}_{habitat}_{scenario}_{time}_dispersal2.pkl")
