...
ax.bar(0, mean_values_mammals[0] ,color="#2a6a99", label="Climate Change")
ax.bar(0.8, mean_sum_bin_change_mammals[0],alpha=0.5,color="#d88546", label="Climate and Land-Use Change")
...
ax.bar(2, mean_values_amphibians[0],color="#2a6a99")
ax.bar(2.8, mean_sum_bin_change_amphibians[0],alpha=0.5,color="#d88546")
...
ax.bar(4, mean_values_birds[0] ,color="#2a6a99")
ax.bar(4.8, mean_sum_bin_change_birds[0],alpha=0.5,color="#d88546")
