...
for taxa in taxas:
    for model in models:
        ...
        available_names = [x.split("_[85].nc")[0] for x in available_file]
...
for taxa in taxas:
    for model in models:
        ...
        scenarios = ["rcp26"]
        model_names = ['IPSL-CM5A-LR', 'HadGEM2-ES', 'MIROC5']
        netcdf_path_format_future = "/storage/homefs/ch21o450/data/BioscenComb_2100/{}/{}/{}/{}/{}_[{}].nc" 
