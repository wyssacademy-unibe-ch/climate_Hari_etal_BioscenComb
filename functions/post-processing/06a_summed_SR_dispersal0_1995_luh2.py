...
for taxa in taxas:
    for sdm in sdms:
        ...
        netcdf_path_format_future = "/storage/scratch/users/ch21o450/data/LandClim_Output/Dispersal0_newbase/{}/{}/{}/{}/{}_[{}].nc"
...
for taxa in taxas:
    for sdm in sdms:
        for gcm in gcms:
            ...
            sum_bin_hist_sum_path = os.path.join(output_dir, f"sum_bin_hist_sum_{sdm}_{gcm}_{taxa}_{scenario}_{time}_dispersal0_newbase.pkl")
            sum_bin_future_sum_path = os.path.join(output_dir, f"sum_bin_future_sum_{sdm}_{gcm}_{taxa}_{scenario}_{time}_dispersal0_newbase.pkl")
