library(tidyverse); library(raster); library(parallel); library(sf); library(Matrix); library(magrittr); library(cowplot)
...
convcodes <- read.csv('/storage/homefs/ch21o450/scripts/BioScenComb/data/IUCN_LUH_converion_table_Carlson.csv')
...
HabitatList <- lapply(Species_bioscen, function(a){
...
LandUseList = "/storage/workspaces/wa_climate/climate_trt/data/LUH2/ssp1_rcp2.6/multiple-states_input4MIPs_landState_ScenarioMIP_UofMD-IMAGE-ssp126-2-1-f_gn_2015-2100.nc"
