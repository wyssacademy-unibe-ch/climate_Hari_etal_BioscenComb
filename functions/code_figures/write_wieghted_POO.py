...
for taxa in taxas:# Get all possible combinations of models and model_names    
    ...
    # Select the 0th time slice in mean_future and mean_hist data arrays
            ...
            filename = f"/storage/homefs/ch21o450/scripts/BioScenComb/intermediate_results/{taxa}_{future_time}_{scenario}_LancClim_SDM_mean_05th_mean_value_bin_future.nc"
