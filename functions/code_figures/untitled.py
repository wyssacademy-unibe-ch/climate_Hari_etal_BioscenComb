            ...
            for scenario in scenarios: 
                ...
                for scenario in scenarios:
                   ...
                   # Create three subplots for each future time and scenario
                    ...
                    #cmap = colors.ListedColormap(['#a6cee3','#1f78b4', '#b2df8a', '#33a02c', '#fb9a99', '#e31a1c','#fdbf6f','#a65628','#f781bf','#999999'])
                    ...
                    im2 = ax2.pcolormesh(diff_sum_bin['lon'].values, diff_sum_bin['lat'].values,  np.where(diff_sum_bin.values > 0, diff_sum_bin.values, np.nan), transform=ccrs.PlateCarree(), cmap="Set1",norm=norm)
