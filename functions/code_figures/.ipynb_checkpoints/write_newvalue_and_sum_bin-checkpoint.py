        ...
        for future_time in future_times:
            for scenario in scenarios: 
                ...
                for scenario in scenarios:
                    ...
                    filename = f"/storage/homefs/ch21o450/scripts/BioScenComb/intermediate_results/{taxa}_{model}_{future_time}_{scenario}_newvalue_future.nc"
                    ...
                    filename2 = f"/storage/homefs/ch21o450/scripts/BioScenComb/intermediate_results/{taxa}_{model}_{future_time}_{scenario}_sum_bin_future.nc"
