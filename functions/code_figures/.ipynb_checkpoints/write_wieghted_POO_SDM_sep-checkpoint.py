    ...
    for model in models :
        ...
        for future_time in future_times:
            ...
            for scenario in scenarios:
                ...
                filename = f"/storage/homefs/ch21o450/scripts/BioScenComb/intermediate_results/{taxa}_{model}_{future_time}_{scenario}_LancClim_SDM_seperte_05th_mean_value_bin_future.nc"
                difference.to_netcdf(filename)
