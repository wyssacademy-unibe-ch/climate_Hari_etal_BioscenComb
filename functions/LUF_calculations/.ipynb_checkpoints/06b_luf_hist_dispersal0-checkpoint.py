    ...
    for taxa in taxas:
        for model_name, bioscen_model_name in zip(model_names, bioscen_model_names):
            ...
            for i, species_name in enumerate(formatted_names):
                ...
                disp0 = bioscen_species["presence"]
                val_disp = z* disp0
                ...
                for variable in list(da_landuse.keys()):
                    if variable != "newvalue" and variable != "sum_bin" and variable != "sum_lu_binary":
                        ...
                        output_directory = "/storage/scratch/users/ch21o450/data/LandClim_Output/Dispersal0/" + model+ "/" + taxa + "/" + model_name + "/"
                        os.makedirs(output_directory, exist_ok=True)


                        da_landuse.to_netcdf("/storage/scratch/users/ch21o450/data/LandClim_Output/Dispersal0/" + model+ "/" + taxa + "/" + model_name + "/"  + formatted_species_name + "_" + str(time)+ ".nc")
