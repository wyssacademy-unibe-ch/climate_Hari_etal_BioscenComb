            ...
            for bioscen_model_name in bioscen_model_names:
                for scenario in scenarios:
                    for l, ssprcp_short in enumerate(ssprcps_shorts):
                        ...
                        #available_names = ['Stachyris_nigriceps']
                        ...
                        for i, species_name in enumerate(formatted_names):
                            ...
                            LandUseList = "/storage/workspaces/wa_climate/climate_trt/chari/WDPA/wdpa_luh2_" + ssprcps_shorts[l] + "_renamed.nc"
                           ...
                           # Create a dictionary with (lat, lon) tuples as keys and the corresponding values from df_sdm as values
                            ...
                            for variable in list(da_landuse.keys()):
                                if variable != "newvalue" and variable != "sum_bin"  and variable != "sum_lu_binary":
                                    ...
                                    output_directory = "/storage/scratch/users/ch21o450/data/PA/new/" + model+ "/" + taxa + "/" + model_name + "/" + scenario + "/"
                                    ...
                                    #da_landuse.to_netcdf("/storage/scratch/users/ch21o450/data/LandClim_Output/new/" + model+ "/" + taxa + "/" + model_name + "/" + scenario + "/" + formatted_species_name + "_" + str(time)+ ".nc")
