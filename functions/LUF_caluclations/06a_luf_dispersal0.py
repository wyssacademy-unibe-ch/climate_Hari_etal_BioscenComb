        ...
        for GCM, bioscen_GCM in zip(GCMs, bioscen_GCMs):
            ...
            for scenario in scenarios:
                ...
                for i, species_name in enumerate(formatted_names):
                    ...
                    disp0 = bioscen_species["presence"] #presence is no dispersal
                    val_disp = z* disp0
                    ...
                    LandUseList = "/storage/workspaces/wa_climate/climate_trt/chari/LUH2/remapped_luh2_" + ssprcp_short + ".nc"
                   ...
                   # Create a dictionary with (lat, lon) tuples as keys and the corresponding values from df_sdm as values
                    ...
                    for variable in list(da_landuse.keys()):
                        if variable != "newvalue" and variable != "sum_bin":
                            ...
                            output_directory = "/storage/scratch/users/ch21o450/data/LandClim_Output/Dispersal0/" + model+ "/" + taxa + "/" + GCM + "/" + scenario + "/"
