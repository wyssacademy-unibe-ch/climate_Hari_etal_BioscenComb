                ...
                for i, species_name in enumerate(formatted_names):
                    ...
                    for code in keys: 
                        ...
                        if code == "MARINE" or not keys:
                            ...
                            output_directory = "/storage/scratch/users/ch21o450/data/LandClim_Output/new/" + model+ "/" + taxa + "/" + model_name + "/"
                            os.makedirs(output_directory, exist_ok=True)

                            da_landuse.to_netcdf("/storage/scratch/users/ch21o450/data/LandClim_Output/new/" + model+ "/" + taxa + "/" + model_name + "/"  + formatted_species_name + "_" + str(time)+ ".nc")
