...
chmod +x /storage/homefs/ch21o450/scripts/BioScenComb/functions/code_figures/write_newvalue_and_sum_bin.py

# Pass the arguments to luf.py
python3 /storage/homefs/ch21o450/scripts/BioScenComb/functions/code_figures/write_newvalue_and_sum_bin.py -a $TAXA -m $MODEL