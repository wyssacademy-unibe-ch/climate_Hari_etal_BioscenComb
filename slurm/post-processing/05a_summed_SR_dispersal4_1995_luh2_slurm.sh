...
chmod +x /storage/homefs/ch21o450/scripts/climate_Hari_etal_inprep/functions/post-processing/05a_summed_SR_dispersal4_1995_luh2.py

# Pass the arguments to luf.py
python3 /storage/homefs/ch21o450/scripts/climate_Hari_etal_inprep/functions/post-processing/05a_summed_SR_dispersal4_1995_luh2.py  -m $SCENARIO -a $TIME
