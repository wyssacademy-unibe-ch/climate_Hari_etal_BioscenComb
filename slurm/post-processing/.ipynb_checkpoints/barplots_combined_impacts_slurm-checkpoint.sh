...
chmod +x /storage/homefs/ch21o450/scripts/BioScenComb/functions/post-processing/barplots_combined_impacts.py

# Pass the arguments to luf.py
python3 /storage/homefs/ch21o450/scripts/BioScenComb/functions/post-processing/barplots_combined_impacts.py  -m $SCENARIO -a $TIME
