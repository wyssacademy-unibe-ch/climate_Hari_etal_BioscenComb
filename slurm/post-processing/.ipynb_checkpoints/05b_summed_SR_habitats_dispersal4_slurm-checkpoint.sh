...
chmod +x /storage/homefs/ch21o450/scripts/climate_Hari_etal_inprep/functions/post-processing/05b_summed_SR_habitats_dispersal4.py

# Pass the arguments to luf.py
python3 /storage/homefs/ch21o450/scripts/climate_Hari_etal_inprep/functions/post-processing/05b_summed_SR_habitats_dispersal4.py  -m $SCENARIO -a $TIME
