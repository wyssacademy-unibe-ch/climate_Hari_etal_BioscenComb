...
chmod +x /storage/homefs/ch21o450/scripts/BioScenComb/functions/post-processing/per_taxa_list_forest_vs_nonforest.py 

# Pass the arguments to luf.py
python3 /storage/homefs/ch21o450/scripts/BioScenComb/functions/post-processing/per_taxa_list_forest_vs_nonforest.py -t $TIME -m $MODEL -a $TAXA