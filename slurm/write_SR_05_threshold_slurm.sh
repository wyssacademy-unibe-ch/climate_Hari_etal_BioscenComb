...
chmod +x /storage/homefs/ch21o450/scripts/BioScenComb/functions/code_figures/write_SR_05_threshold.py

# Pass the arguments to luf.py
python3 /storage/homefs/ch21o450/scripts/BioScenComb/functions/code_figures/write_SR_05_threshold.py -a $TAXA -m $MODEL