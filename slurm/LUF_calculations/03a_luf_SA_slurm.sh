...
chmod +x /storage/homefs/ch21o450/scripts/BioScenComb/functions/LUF_caluclations/03a_luf_SA.py

# Pass the arguments to luf.py
python3 /storage/homefs/ch21o450/scripts/BioScenComb/functions/LUF_caluclations/03a_luf_SA.py -t $TIME -m $MODEL -a $TAXA
